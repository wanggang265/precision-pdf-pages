const steps = [
  { step: "01", label: "Upload your PDF", detail: "Drop the file you want to clean up." },
  { step: "02", label: "Select pages to delete", detail: "Click the pages you want to remove from the preview." },
  { step: "03", label: "Download the result", detail: "Save the trimmed PDF back to your device." },
];

export function RemovePdfHowItWorks() {
  return (
      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-12 sm:px-6 lg:px-8">
        <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-[0_6px_18px_rgba(15,23,42,0.04)] sm:p-6">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl">Remove pages in three steps</h2>
            <p className="mt-3 text-sm leading-6 text-slate-600">
              The process is the same on Mac, Windows, and mobile: upload, select, and download.
            </p>
          </div>
