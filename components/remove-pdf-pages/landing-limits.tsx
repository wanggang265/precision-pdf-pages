...
export function RemovePdfLimits() {
  return (
      ...
      <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-[0_6px_18px_rgba(15,23,42,0.04)] sm:p-6">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl">
            Free page removal limits, shown up front
          </h2>
          <p className="mt-3 text-sm leading-6 text-slate-600">
            The limits are simple and transparent so you know exactly what the free tier covers.
          </p>
        </div>
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1fr_1fr]">
          ...
          <div className="rounded-[24px] border border-slate-200 bg-[linear-gradient(180deg,#0f172a,#111827)] p-6 text-white shadow-[0_20px_50px_rgba(15,23,42,0.18)]">
            ...
            <p className="mt-3 text-lg font-semibold">Your file stays in your browser by default.</p>
            <p className="mt-2.5 text-sm leading-6 text-slate-300">
              For free-tier jobs, the PDF is processed locally. Nothing is uploaded to a server unless you choose a credit-based job beyond the browser limits.
            </p>
