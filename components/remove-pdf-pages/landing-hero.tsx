      ...
      <div className="mx-auto grid w-full max-w-7xl gap-8 px-5 py-12 sm:px-6 lg:grid-cols-[1.08fr_.92fr] lg:px-8 lg:py-16">
        <div className="flex flex-col justify-center">
          ...
          <h1 className="mt-4 max-w-[16ch] text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">
            Remove pages from PDF online, free & secure
          </h1>
          <p className="mt-4 max-w-xl text-lg leading-8 text-slate-600">
            Delete unwanted pages from any PDF in seconds. No signup, no upload to a server, and no watermarks.
          </p>
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            {[
              ...
              { label: "Platforms", value: "Mac, Windows, mobile" },
            ].map((item) => (
              <div
                key={item.label}
            ...
            <div className="p-3.5">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <div className="mt-2 text-lg font-semibold">report-final.pdf</div>
                  <div className="mt-1 text-sm text-slate-300">2 pages selected for removal</div>
                </div>
              </div>
                    ...
                    <div key={page} className="flex items-center justify-between rounded-lg border border-white/10 bg-white/5 px-4 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[11px] text-slate-400">Marked for removal</div>
                        </div>
                      </div>
              ...
              <div className="mt-3.5 flex flex-wrap gap-3">
                <button className="rounded-full bg-rose-500 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-rose-600">
