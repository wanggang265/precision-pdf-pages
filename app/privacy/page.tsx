    ...
    <SiteShell>
      <section className="mx-auto w-full max-w-4xl px-5 py-14 sm:px-6 lg:px-8">
        <PageIntro
          eyebrow="Privacy"
          title="Privacy Policy"
          description="Precision PDF is designed to keep the workflow lightweight and practical. We only aim to use the minimum information needed to provide the service."
          className="max-w-3xl"
        />
        <div className="mt-8 space-y-4">
          ...
          <InfoCard title="Contact">
            ...
            or email <a className="font-semibold text-blue-700" href="mailto:hello@precisionpdf.pages">hello@precisionpdf.pages</a>.
          </InfoCard>
        </div>
      </section>
    </SiteShell>
