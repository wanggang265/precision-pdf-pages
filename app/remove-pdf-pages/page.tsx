      ...
      <section className="mx-auto w-full max-w-7xl px-5 py-12 sm:px-6 lg:px-8">
        <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-[0_6px_18px_rgba(15,23,42,0.04)] sm:p-6">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            >
              <h3 className="text-base font-semibold text-slate-950 group-hover:text-blue-700">Split PDF</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">Split a PDF into multiple files by page ranges.</p>
            </Link>
            <Link
              href="/merge-pdf/"
              className="group rounded-[24px] border border-slate-200 bg-[linear-gradient(180deg,#ffffff,#f8fafc)] p-5 shadow-[0_8px_22px_rgba(15,23,42,0.04)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(15,23,42,0.06)]"
            >
              <h3 className="text-base font-semibold text-slate-950 group-hover:text-blue-700">Merge PDF</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">Combine multiple PDFs into one document.</p>
            </Link>
            <Link
              href="/extract-pdf-pages/"
              className="group rounded-[24px] border border-slate-200 bg-[linear-gradient(180deg,#ffffff,#f8fafc)] p-5 shadow-[0_8px_22px_rgba(15,23,42,0.04)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(15,23,42,0.06)]"
            >
              <h3 className="text-base font-semibold text-slate-950 group-hover:text-blue-700">Extract PDF Pages</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">Keep only the pages you need in a new PDF.</p>
            </Link>
            <Link
              href="/compress-pdf/"
              className="group rounded-[24px] border border-slate-200 bg-[linear-gradient(180deg,#ffffff,#f8fafc)] p-5 shadow-[0_8px_22px_rgba(15,23,42,0.04)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(15,23,42,0.06)]"
            >
              <h3 className="text-base font-semibold text-slate-950 group-hover:text-blue-700">Compress PDF</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">Reduce PDF file size in seconds.</p>
            </Link>
          </div>
        </div>
      </section>
